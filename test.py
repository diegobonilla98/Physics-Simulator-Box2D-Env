...
def AddCar(theWorld, bodies, x=0, vx=0, width=1, height=1, my_restitution=1.00):
    ...
    dynamic_body.CreatePolygonFixture(box=(width, height), density=20.0, friction=0.30, restitution=my_restitution)
...
# --- pybox2d world setup ---
# Create the world
world = b2World(gravity=(-0.0, -50.0), doSleep=True)
...
for j in range(5):
    ...
    vx = j + 2
    # vx = -6
    AddCar(world, bodies, x, 0, height=1.0, width=2.0, my_restitution=0.90)
